...
from sqlalchemy import Column, String, ForeignKey, PrimaryKeyConstraint, Integer, LargeBinary
...
class Auth(db.Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('email', 'authType'),
    )
...
class UserHabit(db.Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('email', 'habitName'),
    )
